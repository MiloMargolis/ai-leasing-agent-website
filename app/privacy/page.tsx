      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white shadow-lg rounded-lg p-8 md:p-12">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Last updated: July 8, 2025</p>
          </div>

          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 mb-6">
              HouseFly AI ("we," "our," or "us") respects your privacy and is committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our SMS-based real estate assistance service.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Information We Collect</h2>
            <p className="text-gray-700 mb-4">We collect the following types of information:</p>
            <ul className="list-disc pl-6 text-gray-700 mb-6 space-y-2">
              <li><strong>Phone Numbers:</strong> Your mobile phone number when you initiate or respond to SMS communications</li>
              <li><strong>Message Content:</strong> The content of SMS messages you send and receive through our service</li>
              <li><strong>Usage Data:</strong> Information about how you interact with our service, including message timestamps and frequency</li>
              <li><strong>Device Information:</strong> Basic technical information such as your mobile carrier and device type</li>
              <li><strong>Real Estate Information:</strong> Property preferences, showing requests, and other real estate-related data you share</li>
            </ul>

            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">How We Use Your Information</h2>
            <p className="text-gray-700 mb-4">We use your information for the following purposes:</p>
            <ul className="list-disc pl-6 text-gray-700 mb-6 space-y-2">
              <li>To provide real estate assistance and coordinate with agents on your behalf</li>
              <li>To respond to your inquiries about properties, showings, and rental information</li>
              <li>To schedule property viewings and coordinate with real estate agents</li>
              <li>To improve our service and develop new features</li>
              <li>To ensure compliance with legal obligations and carrier regulations</li>
              <li>To prevent fraud and maintain the security of our service</li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-6 space-y-2">
              <li><strong>Opt-Out:</strong> You can stop receiving SMS messages at any time by replying "STOP"</li>
              <li><strong>Access:</strong> You can request information about what personal data we have about you</li>
              <li><strong>Correction:</strong> You can request that we correct inaccurate information</li>
              <li><strong>Deletion:</strong> You can request that we delete your personal information, subject to legal requirements</li>
            ...
            <p className="text-gray-700 mb-6">
              We retain your personal information for as long as necessary to provide our services and comply with legal obligations. When you opt out of SMS communications, we will stop sending messages but may retain your information for a limited period to comply with legal requirements and prevent re-enrollment.
            </p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-gray-700 font-semibold mb-2">HouseFly AI</p>
              ...
              <p className="text-gray-700 text-sm">
                For SMS assistance, reply HELP to any message from our service.
              </p>
            </div>
          </div>
